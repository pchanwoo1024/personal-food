...
allergy_options  = ["밀", "대두", "우유", "닭고기", "돼지고기", "생선", "무", "배추", "카레", "달걀", "토마토", "조개", "땅콩", "메밀"]
...
if st.button("식단 추천 실행"):
    ...
    for m in filtered:
            ...
            ideal_protein_ratio = 0.20 + (activity - 1.0) * 0.05
            protein_score = 1 - abs(protein_ratio - ideal_protein_ratio)
